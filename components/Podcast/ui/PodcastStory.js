...
const PodCastStory = ({ link, title, timestamp, description, audioSrc }) => {
  ...
  return (
    <div className="PodcastEpisodeItem w-full mg:p-16 p-6 bg-white border border-neutral-900 border-opacity-90 flex-col justify-start items-start gap-4 inline-flex">
