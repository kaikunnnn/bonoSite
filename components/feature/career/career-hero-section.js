...
export default function HeroSection() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 md:py-24 flex flex-col justify-start items-center relative w-full z-10">
      <div className="w-7/12 mx-auto">
        <div className="CopyArea flex-col justify-start items-center inline-flex">
          <div className="flex-col justify-center items-center gap-6 flex">
            <div className="text-center text-orange-500 text-[120px] font-bold font-['Dongle'] leading-[120px] tracking-[4px]">CAREER</div>
            <div className="text-center text-orange-500 text-[15px] font-bold font-['Noto Sans JP'] leading-snug tracking-[4px]">未経験からの</div>
            <div className="text-center text-orange-500 text-[120px] font-bold font-['Dongle'] leading-[120px] tracking-[4px]">UI/UX</div>
            <div className="text-center text-orange-500 text-[15px] font-bold font-['Noto Sans JP'] leading-snug tracking-[4px]">UI/UXデザイナー</div>
            <div className="text-center text-orange-500 text-[120px] font-bold font-['Dongle'] leading-[120px] tracking-[4px]">GUIDE</div>
            <div className="text-center text-orange-500 text-[15px] font-bold font-['Noto Sans JP'] leading-snug tracking-[4px]">転職ガイド</div>
          </div>
        </div>
        <div className="Decoration w-11/12 h-auto gap-auto justify-between inline-flex items-end">
          <div className="py-3 pt-4 px-5 origin-top-left -rotate-6 bg-white rounded-full border border-black/20 justify-between items-center gap-2.5 flex h-fit w-auto">
            <div className="text-[#131212] text-sm font-bold leading-relaxed tracking-wide">&ldquo;人に寄り添うインターネットの<br />ものづくりをはじめよう&rdquo;</div>
          ...
          <div className="w-20 h-20 bg-gradient-to-bl from-[#f2bbe0] to-[#fccbc0] rounded-full border-4 blur-[85px] absolute top-1/2 -translate-y-1/2 right-0" />
        </div>
        {/* Table of Contents */}
        <div className="TableOfCoontens w-full px-6 py-6 bg-white rounded-[40px] border border-black flex-col justify-start items-start gap-6 inline-flex">
          <div className="self-stretch justify-center items-center gap-3 inline-flex">
            <Image
              ...
              height={20}
            />
            <div className="text-black text-base font-normal font-['DotGothic16'] leading-relaxed tracking-wide">気になるトピックはあるかな？</div>
          </div>
