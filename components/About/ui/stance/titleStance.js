...
function TitleStance({ mainTitle,stanceNumber, chapterDescription }) {
  ...
  return (
    <div className="px-8 py-16 lg:p-16 w-full border-b border-neutral-900 border-opacity-20 flex-col justify-center items-start gap-4 inline-flex ">
        <p className="text-white text-base lg:text-lg font-bold leading-3 tracking-widest" style={textStrokeStyle}>{stanceNumber}</p>
        <h2 className='md:w-[280px] text-neutral-900 text-2xl leading-10 lg:text-3xl lg:leading-[3.2rem] font-bold tracking-widest '>{mainTitle}</h2>
