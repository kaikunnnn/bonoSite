...
import RelatedContentSection from "@/components/feature/career/MoreSection";
  ...
  return (
    <div className="bg-white">
      ...
      <div className="w-full h-[200px] p-2.5 bg-[#fff6fd] border-t border-b border-black flex-col justify-center items-center gap-2.5 inline-flex">
        <div className="w-32 text-center text-[#1e1e1e] text-sm font-bold font-['Noto Sans JP'] leading-[18.48px]">旅のことば</div>
        <div className="text-center text-[#1e1e1e] text-base font-bold font-['Noto Sans JP'] leading-[21.12px]">“デザインはオリジナリティを発揮するもの。と思い込んではいけません。<br/>まずは世の中の良いものに目を向けて”定番”の表現を吸収していくのです”</div>
      </div>
